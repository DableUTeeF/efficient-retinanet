...
allowed_backbones = {
    'efficientnetb0': (('block2_i_MB_swish_1', 'block3_i_MB_swish_1', 'block5_i_MB_swish_1', 'swish_last'), EfficientNetB0),
    'efficientnetb1': (('block2_1_MB_swish_2', 'block3_i_MB_swish_1', 'block5_i_MB_swish_1', 'swish_last'), EfficientNetB1),
    'efficientnetb2': (('block2_1_MB_swish_2', 'block3_i_MB_swish_1', 'block5_i_MB_swish_1', 'swish_last'), EfficientNetB2),
    'efficientnetb3': (('block2_1_MB_swish_2', 'block3_i_MB_swish_1', 'block5_i_MB_swish_1', 'swish_last'), EfficientNetB3),
    'efficientnetb4': (('block2_1_MB_swish_2', 'block3_i_MB_swish_1', 'block5_i_MB_swish_1', 'swish_last'), EfficientNetB4),
    'efficientnetb5': (('block2_1_MB_swish_2', 'block3_i_MB_swish_1', 'block5_i_MB_swish_1', 'swish_last'), EfficientNetB5),
}
